/*
  ...
  - You are about to drop the column `appointmentFree` on the `doctor` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "doctor" DROP COLUMN "appointmentFree",
